...
SUITES = {
    ...
    "losses": (
        "JEPA prediction loss + covariance regularization",
        [
            ...
            _tloss.test_cov_loss_shape,
            _tloss.test_cov_loss_identity,
            _tloss.test_cov_loss_collapsed,
            _tloss.test_cov_loss_gradients_flow,
            _tloss.test_cov_loss_projection_trainable,
        ],
    ),
    "trainer_forward": (
        "JEPATrainer — full forward pass, all modes, gradient flow",
        [
            _tf.test_full_forward_code_only_full_sequence,
            _tf.test_full_forward_code_only_extracted_positions,
            _tf.test_full_forward_code_plus_value,
            _tf.test_full_forward_code_plus_time,
            _tf.test_full_forward_code_plus_value_plus_time,
            _tf.test_gradient_flow,
            _tf.test_variable_span_count,
            _tf.test_losses_are_positive,
        ],
    ),
    "integration": (
